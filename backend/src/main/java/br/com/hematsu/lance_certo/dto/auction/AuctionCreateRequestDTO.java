...
public record AuctionCreateRequestDTO(
        ...
        @NotNull(message = "Start time é obrigatório!") @FutureOrPresent(message = "Start time precisa ser no presente ou no futuro") LocalDateTime startDateAndTime,

        @NotNull(message = "End time é obrigatório!") @Future(message = "End time precisa ser no futuro") LocalDateTime endDateAndTime,
